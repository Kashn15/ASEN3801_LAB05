...
if Problem3_1 == 1
    ...
    odefun = @(t,AC_X) AircraftEOMDoublet(t, AC_X, AC_ctrl31, doublet_size, doublet_time, wind_inertial, aircraft_parameters);
...
if Problem3_2 == 1
    ...
    odefun = @(t,AC_X3) AircraftEOMDoublet(t, AC_X32, AC_ctrl, doublet_size, doublet_time, wind_inertial, aircraft_parameters);
