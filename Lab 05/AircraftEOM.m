...
I = [ap.Ix,0,ap.Ixz;0,ap.Iy,0;0,0,ap.Iz];
...
[Aero_F, Aero_M] = AeroForcesAndMoments(aircraft_state, aircraft_surfaces, wind_inertial, aircraft_parameters);

% Calculate thrust and gravitational forces
% rotor resultant along body z
F_g = aircraft_parameters.m * (R_BE * [0; 0; aircraft_parameters.g]); % gravity expressed in body
F_tot = F_g + Aero_F; % Total forces
...
% Dynamics
uvw_dot  = (F_tot - cross(omega, ap.m * Vb)) / ap.m; % Cross() is MatLab's cross function
