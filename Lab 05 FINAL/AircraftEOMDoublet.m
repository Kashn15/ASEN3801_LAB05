...
function xdotdoublet = AircraftEOMDoublet(time, aircraft_state, aircraft_surfaces, doublet_size, doublet_time, wind_inertial, aircraft_parameters)
...
aircraft_surfaces_new = [de; da; dr; dt];

% Recall Exisiting Aircraft EOM
xdotdoublet = AircraftEOM(time, aircraft_state, aircraft_surfaces_new, wind_inertial, aircraft_parameters);
